...
<div id="r_contents" >
	<form action="/group/meeting/registration.do" method="post" id="reservation">
		...
		<div class="form-group">
			<div class="col-sm-6">
				<input type="text" onclick="sample4_execDaumPostcode()" class="form-control" id="addr" placeholder="주소를 검색해주세요"><br> 
				<input type="text" class="form-control" id="addrDetail" placeholder="상세 주소를 입력해주세요"><br>
		...
		<div id="rAmount"><label for="rAcount">참가비</label><input type="text" id="amount" name="amount" class="form-control" style="width:170px;"/><br></div>
		...
		<div><input type="button" id="btnOk" class="btn btn-primary" value="정모 등록" />&nbsp;&nbsp;&nbsp;<input type="button" id="btnCancel" class="btn btn-default" onClick="location.href='/restaurantsinfo.do?restaurant=${shop.s_id_no}';" value="취소" /></div><br>
