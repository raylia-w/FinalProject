  	...
  	<div class="page-content-inner">
        ...
        <div class="comment-block">
        	<div class="card comment-card comment_5983affe532c2841712b03e9">
        		...
        		<form novalidate="novalidate" class="simple_form new_comment" id="new_comment" action="/group/board/comments.do" accept-charset="UTF-8" data-remote="true" method="post"><input name="utf8" type="hidden" value="✓">
        							...
        							<div class="item-inner">
        								<div class="item-input-wrapper string required comment_body">
        									<div class="item-input item-input-field">
        										<input class="string required" placeholder="댓글을 통해서 궁금증과 설레임을 같이 나눠 보아요." type="text" name="comments" id="comments">
        										<input type="hidden" name="user_nick" id="user_nick" value="${nick }">
        										<input type="hidden" name="board_no" id="board_no" value="${board.board_no }">
        									</div>
        									<input type="button" id="submitBtn" name="submitBtn" value="등록">
        								</div>
        							</div>
        						</div>
        					</li>
