...
<form action="/tiles/group.do" method="post" style="margin-left: 222px; margin-top: 20px;">
<!-- 대분류 -->
<div class="col-md-3"> 
...
<div class="col-md-3"> 
  ...
  <button class="btn btn-common log-btn" style="margin-left: 604px; margin-bottom: 30px; background: #FF6347;">검색</button>
</form>
...
<div class="row">
<div class="col-md-1"> 
<p style="text-align: center;">${i.group_no }</p>
</div>
<div class="col-md-1">
<p style="text-align: center;">${i.group_id }</p>
</div>
<div class="col-md-1">
<p style="text-align: center;">${i.location }</p>
</div>
<div class="col-md-1">
<p style="text-align: center;">${i.location_cat }</p>
</div>
<div class="col-md-1">
<p style="text-align: center;">${i.main_cat }</p>
</div>
<div class="col-md-1">
<p style="text-align: center;">${i.small_cat }</p>
</div>
<div class="col-md-1">
<p style="text-align: center;">${i.personnel }</p>
</div>
<div class="col-md-1">
<p style="text-align: center;">${i.manager_id }</p>
</div>
<div class="col-md-4">
<p style="text-align: center;">${i.intro }</p>
</div>
</div>
</div>
</c:forEach>
